...
**② Extract statements from the rendered md** (never from the JSON), per the
Statement Layer spec. Extraction rules for this pipeline:
...
3. Copy `tools/verify_wiki.py` and `tools/render_slide.py` from this skill into `$WIKI/tools/`
